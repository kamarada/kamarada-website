...
<div class='row'>
    <div class='col-sm-4'>{% include image.html caption="Installation overview" src="/files/2015/11/yast-app-folder.png" %}</div>
    <div class='col-sm-4'>{% include image.html caption="YaST" src="/files/2015/11/installation-overview.png" %}</div>
    <div class='col-sm-4'>{% include image.html caption="Control Center 42.2" src="/files/2015/11/yast.png" %}</div>
</div>
<div class='row'>
<div class='col-sm-2'>
...
<div class='row'>
    <div class='col-sm-3'>{% include image.html caption="GNOME LibreOffice 5 in GNOME 3.20" src="/files/2016/11/LibreOffice_in_GNOME_Leap_42.2.jpg" %}</div>
